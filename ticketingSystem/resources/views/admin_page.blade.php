...
<div class="modal fade" id="viewModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-body">
        ...
        <input type="hidden" class="form-control" id="accpt_logs" name='inprogress' value="Admin accept the ticket" disabled >
    ...
    <div class="modal-footer">
      ...
      <input type = 'submit' class="btn btn-primary" value = "Thread" onclick="window.location='{{ url("/comment_page") }}'">
  </div>
</div>
